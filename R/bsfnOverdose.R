#' Calculate a duration of plasma busulfan concentration over specified toxic limits
#' 
#' \code{bsfnOverdose} calculates a time duration of plasma busulfan concentration over specified toxic limits (40 mg/L or 80 mg/L)
#' 
#' @export
#' @import dplyr
#' @import tidyr
#' @param bsfnConcTimeData data frame containing concentration-time data
#' @return descriptive statistics of duration of toxic concentrations
#' @examples 
#' bsfnOverdose(bsfnConcTime(Weight = 20, Dose = 200, N = 20))
#' bsfnOverdose(bsfnConcTimeMulti(Weight = 20, Dose = 200, N = 20, Tau = 8, Repeat = 4))
#' @seealso \url{https://asan.shinyapps.io/bsfn/}

bsfnOverdose <- function(bsfnConcTimeData){
